...
const Clients: React.FC = () => {
  ...
  const handleCreate = async (data: CreateClientDTO) => {
    try {
      ...
      setError(t('clients.errors.createFailed'));
  ...
  const handleUpdate = async (data: CreateClientDTO) => {
    ...
    try {
      await clientService.update({ id: selectedClient.id, ...data });
      await loadClients();
      setShowForm(false);
      setSelectedClient(undefined);
      setError(null);
    } catch (err) {
      setError(t('clients.errors.updateFailed'));
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      setError(t('clients.errors.deleteFailed'));
