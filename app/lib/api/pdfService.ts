...
export class PDFService {
  ...
  private constructor() {
    ...
    this.apiEndpoint = process.env.NEXT_PUBLIC_LETTER_PRESS_API_ENDPOINT || 'https://letterpress.coolify.alsdienst.de/generate-pdf';
    
    if (!this.apiEndpoint) {
      console.error('NEXT_PUBLIC_LETTER_PRESS_API_ENDPOINT environment variable is not set');
    }
  }
